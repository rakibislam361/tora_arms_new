...
class MemberController
{
  ...
  public function create(Request $request)
  {
    ...
    return view('backend.content.member.create', compact('districts', 'thana_list', 'years', 'thana'));
  }
  ...
  public function edit($id)
  {
    ...
    return view(
      ...
      compact('member', 'districts', 'thana_list', 'thana', 'years', 'degree_name',)
    );
  }
  ...
  {
    $data = request()->validate([
      'last_name' => 'nullable|min:4|max:30',
      'first_name' => 'nullable|min:4|max:30',
