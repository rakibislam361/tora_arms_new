...
class DonationTable extends DataTableComponent
{
    ...
    protected string $pageName = 'Income';
    protected string $tableName = 'Income';

    public function query(): Builder
    {
        return IncomeExpense::with('account', 'payment', 'payerGet', 'user', 'expense')->where('expense_type', 'donation');
    }
    ...
    public function columns(): array
    {
        ...
        return [
            ...
            Column::make(__('Donation Date'), 'expense_date')
                ->searchable()
            ...
            Column::make('Actions')
                ...
                ->format(function ($row) {
                    return view('backend.content.donation.includes.actions')->with(['donation' => $row]);
                }),
        ];
    }
}
