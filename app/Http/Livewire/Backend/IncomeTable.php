...
class IncomeTable extends DataTableComponent
{
    ...
    {
        return IncomeExpense::with('account', 'payment', 'payerGet', 'user', 'expense')->where('expense_type', 'income');
    }
    ...
    public function columns(): array
    {
        ...
        return [
            ...
            Column::make(__('Income Date'), 'expense_date')
                ->searchable()
            ...
            Column::make('Actions')
                ...
                ->format(function ($row) {
                    return view('backend.content.income.includes.actions')->with(['expense' => $row]);
                }),
        ];
    }
}
