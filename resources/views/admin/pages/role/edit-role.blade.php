          ...
          <div class="row">
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br>
                    <form method="POST" action="{{ url('roles/'.$role->id) }}" id="demo-form2" data-parsley-validate="" class="form-horizontal form-label-left" novalidate="">
                      @method('put')
                      @csrf                
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                          <input type="text" id="roleName" name="roleName" required="required" value="{{$role->role_name}}" class="form-control">
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                        <textarea id="roleDescription" required="required" class="form-control" name="roleDescription" data-parsley-trigger="keyup" data-parsley-minlength="20" data-parsley-maxlength="100" data-parsley-minlength-message="Come on! You need to enter at least a 20 caracters long comment.." data-parsley-validation-threshold="10">
