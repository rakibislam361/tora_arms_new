                            ...
                            <div class="card-body p-0">
                                ...
                                <div class="row mb-3 px-4">
                                    ...
                                    <div class="col-md-4 col-sm-12">
                                        ...
                                        <input type="text" class="form-control" name="agent_name" id="agent_name" value="{{ $agent->user->name }}">
                                    </div>
                                    ...
                                    <div class="col-md-4 col-sm-12">
                                        <div class="form-group">
                                            <?php
                                            $male = $agent->user->gender == 'Male' ? 'checked' : '';
                                            $female = $agent->user->gender == 'Female' ? 'checked' : '';
                                            ?>
                                            <br>
                                    ...
                                    <div class="col-md-4 col-sm-12">
                                        ...
                                        <textarea name="city_address" id="city_address" class="form-control">{{$agent->city_address}}</textarea>
                                    </div>

                                    <div class="col-md-4 col-sm-12">
                                        <label for="provisional_address" class="form-label">Provisional Address</label>
                                        <textarea name="provisional_address" id="provisional_address" class="form-control">{{$agent->provisional_address}}</textarea>
                                    </div>
                                    ...
                                    <div class="col-md-4 col-sm-12">
                                        ...
                                        <input type="text" class="form-control" name="phone" id="phone" value="{{$agent->user->phone}}">
                                    </div>
                                    <div class="col-md-4 col-sm-12">
                                        <label for="email" class="form-label">Email Address</label>
                                        <input type="email" class="form-control" name="email" id="email" value="{{$agent->user->email}}">
                                    </div>
                                    <div class="col-md-4 col-sm-12">
