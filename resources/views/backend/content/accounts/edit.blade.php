...
@section('content')
    ...
    {{ html()->modelForm($account_information, 'PUT', route('admin.transection-accounts.update', $account_information))->class('form-horizontal')->attribute('enctype', 'multipart/form-data')->open() }}
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                {{ html()->textarea('note')->class('editor form-control')->placeholder('Account Description') }}
                                @error('description')
