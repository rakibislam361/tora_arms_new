...
@section('content')
    ...
    {{ html()->form('POST', route('admin.donation.store'))->attribute('enctype', 'multipart/form-data')->open() }}
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                {{ html()->select('account_id', collect($account))->class('form-control js-example-basic-single')->style('width:100%;')->placeholder('') }}
                                <p class="text-danger margin-bottom-none" id="post_error">
                                    @error('account_id')
                                        {{ $message }}
                                    @enderror
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                {{ html()->select('expense_id', collect($income))->class('form-control js-example-basic-single')->style('width:100%;')->placeholder('') }}
                                <p class="text-danger margin-bottom-none" id="post_error">
                                    @error('expense_id')
                                        {{ $message }}
                                    @enderror
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                {{ html()->text('reference')->class('form-control cash')->style('width:100%;')->placeholder('Reference') }}
                                <p class="text-danger margin-bottom-none" id="reference">
                                    @error('reference')
                                        {{ $message }}
                                    @enderror
                                </p>
