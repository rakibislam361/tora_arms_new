...
@section('content')
    ...
    {{ html()->modelForm($expense_details, 'PUT', route('admin.transection-expense.update', $expense_details))->class('form-horizontal')->attribute('enctype', 'multipart/form-data')->open() }}
