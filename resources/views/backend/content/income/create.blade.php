...
@section('content')
    ...
    {{ html()->form('POST', route('admin.income.store'))->attribute('enctype', 'multipart/form-data')->open() }}
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                {{ html()->select('expense_id', collect($income), old('expense_id'))->class('form-control js-example-basic-single')->style('width:100%')->placeholder('') }}
                                <p class="text-danger margin-bottom-none" id="post_error">
                                    @error('expense_id')
                                        {{ $message }}
                                    @enderror
