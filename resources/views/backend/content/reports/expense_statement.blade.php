...
@section('title', __('Expenses sheet'))

@section('content')

    <x-backend.card xmlns:livewire="">
        <x-slot name="header">
            @lang('Expenses statement')
        </x-slot>
        ...
        <x-slot name="body">
            <div class="card-body">
                <div class="report-params p-3" style="border: solid #d9d9d9 3px;">
                    <form class="validate" method="GET" action="{{ route('admin.expense.statement') }}"
                        novalidate="">
                        <div class="row">
                            @csrf
                            <div class="col-md-3">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <table class="table table-bordered dataTable balance_table" role="" aria-describedby="">
                                ...
                                <tbody>
                                    <?php $expense = 0; ?>
                                    @forelse ($expense_details as $key => $value)
                                        <?php
                                ...
                                <tfoot>
                                    <tr>
                                        ...
                                        <td colspan="1" class="text-right">
                                            <b>{{ count($expense_details) > 0 ? number_format($expense, 2, '.', ',') : '' }}</b>
                                        </td>
                                    </tr>
