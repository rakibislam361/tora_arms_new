        ...
        <x-slot name="body">
            <div class="card-body">
                <div class="report-params p-3" style="border: solid #d9d9d9 3px;">
                    <form class="validate" method="GET" action="{{ route('admin.income.statement') }}" novalidate="">
                        <div class="row">
                            @csrf
                            <div class="col-md-3">
                            ...
                            <table class="table table-bordered dataTable balance_table" role="" aria-describedby="">
                                <thead style="background-color: #737f8b; color: white">
                                    <tr>
                                        ...
                                        <th class="" rowspan="1" colspan="1">Income purpose</th>
                                ...
                                <tbody>
                                    ...
                                    $subscription = 0;
                                    ?>
                                    @forelse ($income_details as $key => $value)
                                        <?php
                                ...
                                <tfoot>
                                    <tr>
                                        ...
                                        <td colspan="1" class="text-right">
                                            <b>{{ count($income_details) > 0 ? number_format($income + $donation + $subscription, 2, '.', ',') : '' }}</b>
                                        </td>
                                    </tr>
