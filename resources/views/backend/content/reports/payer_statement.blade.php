...
@section('title', __('Payer statement'))

@section('content')

    <x-backend.card xmlns:livewire="">
        <x-slot name="header">
            @lang('Payer statement')
        </x-slot>
        ...
        <x-slot name="body">
            <div class="card-body">
                <div class="report-params p-3" style="border: solid #d9d9d9 3px;">
                    <form class="validate" method="GET" action="{{ route('admin.payer.statement') }}" novalidate="">
                        <div class="row">
                            @csrf
                            <div class="col-md-3">
                        ...
                        <div class="col-sm-12">
                            <table class="table table-bordered dataTable balance_table" role="" aria-describedby="">
                                ...
                                <tbody>
                                    ...
                                    $subscription = 0;
                                    ?>
                                    @forelse ($payer_details as $key => $value)
                                        <?php
                                ...
                                <tfoot>
                                    <tr>
                                        ...
                                        <td colspan="1" class="text-right">
                                            <b>{{ count($payer_details) > 0 ? number_format($income + $donation + $subscription - $expense, 2, '.', ',') : '' }}</b>
                                        </td>
                                    </tr>
