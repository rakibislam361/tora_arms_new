...
@section('content')
    ...
    {{ html()->form('POST', route('admin.status.store'))->attribute('enctype', 'multipart/form-data')->open() }}
    ...
    <x-backend.card>
        ...
        <x-slot name="headerActions">
            <x-utils.link-header class="btn btn-sm btn-tool btn-secondary" icon="fas fa-backspace"
                :href="route('admin.status.index')" :text="__('Cancel')" />
        </x-slot>
                        ...
                        <x-slot name="body">
                            ...
                            <div class="form-group">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="status_for" id="status_for1"
                                        value="member" checked>
                                    <label class="form-check-label" for="status_for1">
                                        Only for Member
                                    </label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="status_for" id="status_for2"
                                        value="agent">
                                    <label class="form-check-label" for="status_for2">
                                        Agent only
                                    </label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="status_for" id="status_for3"
                                        value="transection">
                                    <label class="form-check-label" for="status_for3">
                                        Transection
                                    </label>
                                </div>
                                <div class="form-check">
