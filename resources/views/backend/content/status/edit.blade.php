...
@section('content')
    ...
    {{ html()->modelForm($status, 'PUT', route('admin.status.update', $status))->class('form-horizontal')->attribute('enctype', 'multipart/form-data')->open() }}
                    ...
                    <x-backend.card>
                        ...
                        <x-slot name="body">
                            ...
                            <x-slot name="footer">
                                ...
                                <a href="route('admin.status.index')" class="btn btn-danger" type="reset">@lang('Cancel')</a>
                            </x-slot>
                        </x-backend.card>
                    </div> <!-- .col-md-9 -->
                </div>
