...
@section('title', __('Update Subscription'))
...
@section('content')
    ...
    {{ html()->modelForm($expense_details, 'PUT', route('admin.subscription.update', $expense_details))->class('form-horizontal')->attribute('enctype', 'multipart/form-data')->open() }}
