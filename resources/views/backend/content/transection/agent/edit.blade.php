...
@section('content')
    ...
    {{ html()->form('PUT', route('admin.agent-transection.update', $transection->id))->attribute('enctype', 'multipart/form-data')->open() }}
    ...
    <x-backend.card>
        ...
        <x-slot name="headerActions">
            <x-utils.link-header class="btn btn-sm btn-tool btn-warning" icon="fas fa-user-group"
                :href="route('admin.agent-transection.list')" :text="__('View all')" />
