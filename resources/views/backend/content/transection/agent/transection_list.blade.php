...
@section('content')
    ...
    <x-backend.card>
        ...
        <x-slot name="headerActions">
            <x-utils.link-header class="btn btn-sm btn-tool btn-primary" icon="fas fa-user-group"
                :href="route('admin.agent-transection.edit',$transection_details->id)" :text="__('Add new')" />
                                ...
                                @forelse ($transection_details->transectionUser as $key => $transection)
                                    <tr>
                                        ...
                                        <td class="text-left align-middle">
                                            ...
                                            <a href="{{ route('admin.agent-transection.show', $transection->id) }}">{{ $transection->invoice_number }}.
                                        </td>
