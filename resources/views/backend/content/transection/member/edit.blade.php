...
@section('content')
    ...
    {{ html()->form('PUT', route('admin.transection.update', $transection->id))->attribute('enctype', 'multipart/form-data')->open() }}
        ...
        <x-slot name="headerActions">
            @if ($logged_in_user->hasAllAccess())
                <x-utils.link-header class="btn btn-sm btn-tool btn-warning" icon="fas fa-user-group"
                    :href="route('admin.transection.list', $transection->id)" :text="__('View all')" />
            @else
                <x-utils.link-header class="btn btn-sm btn-tool btn-warning" icon="fas fa-user-group"
                    :href="route('admin.transection.index')" :text="__('View all')" />
            @endif
            <x-utils.link-header class="btn btn-sm btn-tool btn-secondary" icon="fas fa-backspace"
                :href="route('admin.transection.show', $transection->id)" :text="__('Cancel')" />
        </x-slot>
