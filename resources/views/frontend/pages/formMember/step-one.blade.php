<div class="row">
    <div class="col-md-9">
        ...
        <div class="row mb-3 px-4">
            ...
            <div class="col-md-4 col-sm-12">
                <label for="personal" class="form-label">Date of birth <sup style="color:red">★</sup></label>
            ...
            <div class="col-md-4 col-sm-12">
                <label for="religion" class="form-label">Police/Civil 1Case/Punishment
            ...
            <div class="col-md-4 col-sm-12">
                <label for="personal" class="form-label">Phonen <sup style="color:red">★</sup></label>
            ...
            <div class="col-md-4 col-sm-12">
                <label for="phone_father" class="form-label">Phone father</label>
                <div class="input-group mb-2">
                    <div class="input-group-prepend">
                        <div class="input-group-text">+88</div>
                    </div>
                    <input type="text" class="form-control phon_validation" name="phone_father"
                        value="{{ old('phone_father'), get_step_value('step1', 'phone_father') }}" placeholder="">
                </div>
            ...
            <div class="col-md-4 col-sm-12">
                <label for="phone_others" class="form-label">Phone others</label>
                <div class="input-group mb-2">
                    <div class="input-group-prepend">
                        <div class="input-group-text">+88</div>
                    </div>
                    <input type="text" class="form-control phon_validation" name="phone_others"
                        value="{{ old('phone_others'), get_step_value('step1', 'phone_others') }}" placeholder="">
                </div>
                ...
                <div class="form-group">
                    <label for="passport_photocopy" class="form-label">Passport
                        photocopy: <br> <small style="font-size:12px;">(jpg, jpeg, doc, docx,
                            pdf)</small></label>
                    <input type="file" class="form-control dropify" name="passport_photocopy" id="passport_photocopy"
